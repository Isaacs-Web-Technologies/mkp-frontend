...
const SignUpPage = () => {
    ...
    return (
    <div className="relative bg-primary lg:w-full  h-[64rem]  overflow-hidden text-center text-[1.5rem] text-sec-color font-poppins"> 
    ...
    <div className="absolute top-[0rem] left-[6.81rem] text-[2.25rem] font-semibold">Create your account</div>
    <div className="absolute top-[5.25rem] left-[0rem] text-center">
   ...
   <form onSubmit={handleSubmit}>
        <div className="absolute top-[14.19rem] left-[0rem] bg-gainsboro box-border w-full md:w-[37.19rem] h-[7.06rem] border-[1px] border-solid border-primary">
          <input
            type="email"
        ...
        <button
          type="submit"
          className="absolute top-[23.75rem] left-0 w-full bg-primary overflow-hidden flex justify-center py-[1.56rem] text-sec-color"
        >
          Continue
        </button>
      </form>

    <div className="absolute top-[31.63rem] left-[6.38rem]">Already have an account? Log in</div>
