...
const Message = (props) => {
  ...
  return (
    ...
    >
      ...
      <div className={`text-base  md:max-w-2xl lg:max-w-xl xl:max-w-3xl flex lg:px-0 w-full m-auto ${isUser ? "flex-row-reverse" : "flex-row "}`}>
        ...
        <div className="relative flex w-[calc(100%-50px)] flex-col gap-1 md:gap-3 lg:w-[calc(100%-115px)]">
          ...
          <div className="flex flex-grow flex-col m-0 p-0">
            <div className={` rounded-lg ${isUser ? "bg-primary text-white right-0 p-2 mr-0 mt-4 mb-4 ml-8" : "bg-primary/10 text-black left-0 p-2 ml-0 mt-4 mb-4 mr-8"} min-h-20 flex flex-col items-end  whitespace-pre-wrap break-words`}>
