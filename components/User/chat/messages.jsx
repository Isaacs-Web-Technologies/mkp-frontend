      ...
      <div className={`text-base gap-4 md:gap-6 md:max-w-2xl lg:max-w-xl xl:max-w-3xl flex lg:px-0 m-auto w-full ${isUser ? "flex-row-reverse" : "flex-row"}`}>
        ...
        <div className="relative flex w-[calc(100%-50px)] flex-col gap-1 md:gap-3 lg:w-[calc(100%-115px)]">
          ...
          <div className="flex flex-grow flex-col gap-3">
            <div className={`p-2 mr-0 mt-4 mb-4 ml-1 rounded-lg ${isUser ? "bg-primary text-white" : "bg-primary/10 text-black"} min-h-20 flex flex-col items-end gap-2 whitespace-pre-wrap break-words`}>
